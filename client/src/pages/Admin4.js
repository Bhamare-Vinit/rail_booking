...
function DeleteTrain() {
  ...
  return (
    <div className="train-container" style={{ backgroundImage: 'url("bg3.jpg")', backgroundSize: 'cover', backgroundPosition: 'center', height:700 ,width:1600 }}>
